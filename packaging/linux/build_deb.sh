...
caleneff (3.0) stable; urgency=low

  * Initial release.
  * Help section: HowTo, Knowledge Database (13 calibration sources), About.

 -- grainovski <grainovski@googlemail.com>  Thu, 27 Aug 2026 00:00:00 +0000
EOF
...
Depends: python3 (>= 3.8), python3-numpy, python3-scipy, python3-matplotlib, python3-tk
